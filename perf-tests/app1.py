...
def print_kv():
    global in_memory_db
    for key in in_memory_db:
        print key, in_memory_db[key]
...
def print_summarized_kv():
    ...
    for key in in_memory_db:
         ...
         pkt_revd_count = pkt_revd_count + in_memory_db[key]["packets_received"]
         pkt_lost_count = pkt_lost_count + in_memory_db[key]["packets_lost"]
